...
class ConfluenceRestClient:
    ...
    def __init__(self, base_url: str, username: str, api_token: str, verify_ssl: bool = False, auth_type: str = 'bearer'):
        """
    ...
    def get_all_pages_from_space(self, space_key: str, expand: Optional[List[str]] = None) -> List[ConfluencePage]:
        """
    ...
    def get_page_by_id(self, page_id: str, expand: Optional[List[str]] = None) -> Optional[ConfluencePage]:
        """
    ...
    def _parse_page_data(self, page_data: Dict[str, Any]) -> ConfluencePage:
        ...
        if 'view' in body:
            content_text = body['view'].get('value', '')
...
def main():
    ...
    if not all([confluence_url, username, api_token]):
        ...
        print("Please ensure CONFLUENCE_URL, CONFLUENCE_USERNAME, and CONFLUENCE_API_TOKEN are set in .env")
        return
    ...
    client = ConfluenceRestClient(confluence_url, username, api_token, verify_ssl=False, auth_type='bearer')
    if not client.test_connection():
        print("\nAttempt 2: Testing Basic authentication...")
        client = ConfluenceRestClient(confluence_url, username, api_token, verify_ssl=False, auth_type='basic')
        if not client.test_connection():
